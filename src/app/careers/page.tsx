      ...
      <Dialog open={isOpen} onOpenChange={(open) => { if (!open) closeModal() }}>
        <DialogContent className="sm:max-w-md bg-gradient-to-b from-gray-100 to-white dark:from-[#0e0e15] dark:to-[#1E1E2F]">
          ...
          <form className="space-y-4 mt-4">
            <Input type="text" placeholder="Your Name" required className="w-full px-4 py-2 border rounded dark:bg-gray-800 dark:text-white" />
            <Input type="email" placeholder="Your Email" required className="w-full px-4 py-2 border rounded dark:bg-gray-800 dark:text-white" />
            <Textarea rows={4} placeholder="Cover Letter" required className="w-full px-4 py-2 border rounded dark:bg-gray-800 dark:text-white" />
